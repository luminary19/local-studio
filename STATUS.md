...
- [x] Inspect project context comments.
- [x] Remove redundant project context field comments.
- [x] Validate frontend project context comment cleanup slice.
- [x] Commit this slice.
