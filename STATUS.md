...
- [ ] Add controller integration and e2e tests for all active controller flows. Initial integration smoke coverage exists for core route contracts, raw observability persistence, studio settings/provider CRUD, recipe CRUD, and runtime/download validation routes; full active-flow coverage remains.
